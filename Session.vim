...
noremap <silent>  :call smooth_scroll#up(&scroll*2, 10, 4)
noremap <silent>  :call smooth_scroll#down(&scroll*2, 10, 4)
snoremap <silent>  c
tmap  
nnoremap   
nmap <NL> :vertical terminal 
...
noremap <silent>  l :ObviousResizeRight
noremap <silent>  h :ObviousResizeLeft
...
noremap <silent> <C-Down> :ObviousResizeDown
noremap <silent> <C-Up> :ObviousResizeUp
xmap <BS> "-d
...
set runtimepath+=~/.vim/bundle/MatchTagAlways
set runtimepath+=~/.vim/bundle/neocomplete.vim
set runtimepath+=~/.vim/bundle/nerdtree
set runtimepath+=~/.vim/bundle/obvious-resize
...
set runtimepath+=~/.vim/bundle/vim-coloresque
...
set runtimepath+=~/.vim/bundle/vim-smooth-scroll
set runtimepath+=~/.vim/bundle/vimtex
set runtimepath+=~/.vim/bundle/YouCompleteMe
set runtimepath+=/usr/local/Cellar/macvim/8.1-153/MacVim.app/Contents/Resources/vim/vimfiles
set runtimepath+=/usr/local/Cellar/macvim/8.1-153/MacVim.app/Contents/Resources/vim/runtime
set runtimepath+=/usr/local/Cellar/macvim/8.1-153/MacVim.app/Contents/Resources/vim/vimfiles/after
set runtimepath+=~/.vim/bundle/vimtex/after
set runtimepath+=~/.vim/bundle/vim-coloresque/after
...
silent only
silent tabonly
cd ~/Documents/iith_summer_2019/modelcompression/walt_code
